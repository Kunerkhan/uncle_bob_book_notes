# clean_code_notes
Это конспет по книге Роберта Мартина "Чистый код".
...
3. [Чистый код](#Чистый-код)
4. [Форматирование](#Форматирование)
5. [Имена](#Имена)
6. [Функции](#Функции)
7. [Комментарии](#Комментарии)
8. [Объекты и структуры данных](#Объекты-и-структуры-данных)
9. [Обработка ошибок](#Обработка-ошибок)
10. [Модульные тесты](#Модульные-тесты)
11. [Классы](#Классы)
12. [Системы](#Системы)
13. [Формирование архитектуры](#Формирование-архитектуры)
...
Я обратился к классике в мире программирования - книгам Роберта Мартина. Книга “Чистый код” помогла мне взглянуть на программирование по-другому.

Раньше программирование было мечтой и способом заработать, теперь я смотрю на это как на творческий процесс, как на способ самовыражения. Я уже применяю в работе приемы из книги и других источников по написанию “чистого кода”, и вижу как код становится понятнее и становится проще ориентироваться в проекте. Это вдохновляет узнавать больше.
...
Впервые я читал ее еще будучи новичком в IT, тогда я смог вынести только то, что был в силах понять. Те знания были лишь малой частью, которые книга может дать.

Чтобы помочь новичкам я решил написать заметки из книги, выжав воду. Старался написать максимально просто и понятно, чтобы программист любого уровня мог понять материал. Надеюсь, что у меня получилось.
